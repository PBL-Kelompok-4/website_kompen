        ...
        <table class="border-all">
            <thead>
                <tr>
                    ...
                    <th>Jumlah Jam Kompen Selesai Dilakukan</th>
                    <th>Sisa Jam Kompen</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($mahasiswa_alpha as $ma)
                    <tr>
                        <td class="text-center">{{ $loop->iteration }}</td>
                        <td>{{ $ma->prodi->nama_prodi }}</td>
                        <td>{{ $ma->nama }}</td>
                        <td>{{ $ma->nomor_induk }}</td>
                        <td>{{ $ma->periode->periode }}</td>
                        <td>{{ $ma->jam_alpha }}</td>
                        <td>{{ $ma->jam_kompen }}</td>
                        <td>{{ $ma->jam_kompen_selesai }}</td>
                        <td>{{ $ma->sisa_kompen }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
