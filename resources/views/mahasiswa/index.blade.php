    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ url('/mahasiswa/export_excel') }}" class="btn btn-primary"><i class="fa fa-file-excel"></i> Export Data Mahasiswa</a>
                <a href="{{ url('/mahasiswa/export_pdf') }}" class="btn btn-warning"><i class="fa fa-file-pdf"></i> Export Data Mahasiswa</a>
                <button onclick="modalAction('{{ url('mahasiswa/create_ajax') }}')" class="btn btn-success">Tambah Data Mahasiswa</button>
            </div>
        </div>
        <div class="card-body">
            @if(session('success'))
