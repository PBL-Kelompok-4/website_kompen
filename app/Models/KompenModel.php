...
class KompenModel extends Model
{
    ...
    protected $fillable = ['id_personil', 'id_jenis_kompen', 'nomor_kompen', 'nama', 'deskripsi', 'kuota', 'jam_kompen', 'status', 'is_selesai','status_acceptance', 'tanggal_mulai', 'tanggal_selesai'];
